...
const STATUS_OPTIONS: {
...
}[] = [
  {
    ...
    label: "Good",
    bg: colors.surface,
    bgActive: colors.successFill,
    borderActive: colors.successFillBorder,
    textActive: "#FFFFFF",
  },
  {
    key: "attention",
    label: "Attention",
    bg: colors.surface,
    bgActive: colors.warnFill,
    borderActive: colors.warnFillBorder,
    textActive: "#FFFFFF",
  },
  {
    key: "urgent",
    label: "Urgent",
    bg: colors.surface,
    bgActive: colors.dangerFill,
    borderActive: colors.dangerFillBorder,
    textActive: "#FFFFFF",
  },
];
