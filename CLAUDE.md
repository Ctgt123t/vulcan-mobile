...
- **Stuck "adapter connected" status bar** — the connection status indicator can remain showing "connected" after the adapter has actually disconnected, so the UI state lags the real transport state.
