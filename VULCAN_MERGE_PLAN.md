...
- **Next:** founder runs the consolidated on-device checklist → then **Phase 5 (optional, in-diagnosis retrieval) remains a separate, explicitly-approved step** — the only fence-adjacent work. Do not start it without explicit approval.
