...
- **Next:** begin **Phase 3** (persistent chats — required pre-shell). Phase 5 is the only fence-adjacent change and is gated last. **The unified shell (Phase 4) must not ship before persistent chats (Phase 3) — hard gate.**
