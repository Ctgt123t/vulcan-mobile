...
ok(eqArr(filterOptions(makes, "hon"), ["Honda"]), "case-insensitive substring (hon -> Honda)");
ok(eqArr(filterOptions(makes, "H"), ["Honda", "Hyundai"]), "single char matches multiple");
ok(eqArr(filterOptions(makes, "benz"), ["Mercedes-Benz"]), "matches mid-string + punctuation");
